...
function removeIndependentism(textNode) {
	...
	v = v.replace(/\bconsulta seccessionista\b/g, "gran adoració al pa de pessic de xocolata");
    v = v.replace(/\bindependent\b/g, "brillant com la purpurina");
    v = v.replace(/\bIndependent\b/g, "Brillant com la purpurina");
    ...
    v = v.replace(/\bla via catalana\b/g, "el ball del rodó");
    v = v.replace(/\bla Vía Catalana\b/g, "el Corro de la Patata");
    v = v.replace(/\bVía Catalana\b/g, "Corro de la Patata");
	v = v.replace(/\bVia Catalana\b/g, "Ball del Rodó");
	...
	v = v.replace(/\bderecho a decidir\b/g, "derecho a comer pasteles");
	v = v.replace(/\bderecho a Decidir\b/g, "derecho a comer pasteles"); 
	v = v.replace(/\bdret a decidir\b/g, "Dret a menjar pastissos");
	v = v.replace(/\bDret a Decidir\b/g, "dret a menjar pastissos");
	v = v.replace(/\bdret a Decidir\b/g, "dret a menjar pastissos");
	...
	v = v.replace(/\bEstado propio\b/g, "Estado gaseoso");
	v = v.replace(/\bestado propio\b/g, "Estado gaseoso");
	v = v.replace(/\bestado soberano\b/g, "Estado gaseoso");
	v = v.replace(/\bveto a la consulta\b/g, "rechazo a la rica miel");
	v = v.replace(/\brechazo a la consulta\b/g, "rechazo a la rica miel"); 
	v = v.replace(/\brebuig a la consulta\b/g, "rebuig a la bona mel");
    v = v.replace(/\bsoberanista\b/g, "mágica");
    v = v.replace(/\bSoberanista\b/g, "mágica");
	v = v.replace(/\bPilar Rahola\b/g, "Reina de las Croquetas, Pilar Rahola");
	v = v.replace(/\bNacióDigital.cat\b/g, "NaciónDePlastilina.cat");
	v = v.replace(/\bNació Digital\b/g, "Nación de plastilina");
	v = v.replace(/\bnació digital\b/g, "Nación de plastilina");
	v = v.replace(/\bnaciodigital.cat\b/g, "NacionDePlastilina.cat");
	v = v.replace(/\bestat propi\b/g, "estat gasós");
	v = v.replace(/\bestat propi\b/g, "estat gasós");	
	v = v.replace(/\bEstat propi\b/g, "Estat gasós"); 
